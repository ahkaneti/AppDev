...
class ProfilePage extends Component{
  ...
  takePicture = async function() {
     if (this.camera) {
       ...
       this.loadAvatarFunction(data.base64);
       this.uploadAvatarFunction();
     }
     this.toggleCamera()
   };
    ...
    return(
     ...
     <View style={{ flex: 0, flexDirection: 'row', justifyContent: 'center' }}>
       <TouchableOpacity onPress={this.takePicture.bind(this)} style={styles.capture}>
        ...
        <TouchableOpacity style={styles.edit} onPress={()=> this.toggleCamera()}><Image style={{width: 40, height: 40}} source={require('../../images/gear.png')}/></TouchableOpacity>
